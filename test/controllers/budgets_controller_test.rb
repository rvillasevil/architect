...
class BudgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget" do
    assert_difference('Budget.count') do
      post budgets_url, params: { budget: { cost: @budget.cost, reform_id: @budget.reform_id, user_id: @budget.user_id } }
    end
  ...
  test "should update budget" do
    patch budget_url(@budget), params: { budget: { cost: @budget.cost, reform_id: @budget.reform_id, user_id: @budget.user_id } }
