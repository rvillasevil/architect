...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { comentario: @contacto.comentario, email: @contacto.email, tipo: @contacto.tipo } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { comentario: @contacto.comentario, email: @contacto.email, tipo: @contacto.tipo } }
