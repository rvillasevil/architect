class BanosController < ApplicationController
  ...
  # GET /banos/1/edit
  def edit
    @bano = Bano.find_by(id: params[:id], reform_id: params[:reform_id])
  end
  ...
  def create
    ...
    respond_to do |format|
      if @bano.save
        format.html { redirect_to reform_bano_path(id: @bano, reform_id: @bano.reform_id), notice: 'Bano was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @bano.update(bano_params)
        format.html { redirect_to reform_bano_path(id: params[:id], reform_id: @bano.reform_id), notice: 'Bano was successfully updated.' }
  ...
  def destroy
    ...
    @bano.destroy
    respond_to do |format|
      format.html { redirect_to @reform, notice: 'Bano was successfully destroyed.' }
      # format.html { redirect_to reform_banos_path(reform_id: @bano.reform_id), notice: 'Bano was successfully destroyed.' }
