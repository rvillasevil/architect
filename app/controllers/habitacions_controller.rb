class HabitacionsController < ApplicationController
  ...
  before_action :logged_in_user, only: [ :edit, :update, :destroy, :index,  :update]  # :show, :create,
